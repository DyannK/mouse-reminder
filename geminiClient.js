...
function buildGayaInstruction(isUppercase = false) {
    if (isUppercase) {
        return 'gaya bahasa wajib menggunakan HURUF KAPITAL SEMUA (ALL CAPS/UPPERCASE) untuk seluruh kalimat, kata panggilan, dan penjelas tanpa kecuali bray! jangan gunakan huruf kecil sama sekali! buat ekspresinya mengalir sangat marah, ketus, atau tegas sesuai tema wa anak tongkrongan sehari-hari. dilarang keras menyisipkan tanda koma tepat sebelum panggilan nama. buang total atau kurangi penggunaan tanda baca berlebih atau lebay.';
    }
